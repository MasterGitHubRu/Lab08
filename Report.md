...
```ShellSession
$ export GITHUB_USERNAME=<имя_пользователя> //создаем переменную с ником на гитхабе
...
```ShellSession
$ gsed -i '/project(print)/a\ //записываем в СиМэйк версию String
set(PRINT_VERSION_STRING "v${PRINT_VERSION}")
' CMakeLists.txt
$ gsed -i '/project(print)/a\ //записываем в СиМэйк общую версию
set(PRINT_VERSION \
\${PRINT_VERSION_MAJOR}.\${PRINT_VERSION_MINOR}.\${PRINT_VERSION_PATCH}.\${PRINT_VERSION_TWEAK})
' CMakeLists.txt
$ gsed -i '/project(print)/a\ //записываем в СиМэйк версию Tweak
set(PRINT_VERSION_TWEAK 0)
' CMakeLists.txt
$ gsed -i '/project(print)/a\ //записываем в СиМэйк версию Patch
set(PRINT_VERSION_PATCH 0)
' CMakeLists.txt 
$ gsed -i '/project(print)/a\ //записываем в СиМэйк версию Minor
set(PRINT_VERSION_MINOR 1)
' CMakeLists.txt
$ gsed -i '/project(print)/a\ //записываем в СиМэйк версию Major
...
```ShellSession
$ cat >> CPackConfig.cmake <<EOF //записываем в СиМэйк параметры сборки
...
```ShellSession
$ cat >> CPackConfig.cmake <<EOF //записываем в СиМэйк параметры для лицензии и ридми
...
```ShellSession
$ cat >> CPackConfig.cmake <<EOF //записываем в СиМэйк дополнительные параметры пакетирования (название, лицензия, URL и тд)
...
```ShellSession
$ cat >> CPackConfig.cmake <<EOF //записываем в СиМэйк параметры для Debian
...
```ShellSession
$ gsed -i 's/lab07/lab08/g' README.md //записываем новую лабу
```
...
To https://github.com/Kutyirov/lab08
...
Detected repository as Kutyirov/lab08, is this correct? |yes| yes
Kutyirov/lab08: enabled :)
...
-- Configuring done
-- Generating done
-- Build files have been written to: /Users/mac/Kutyirov/workspace/projects/lab08/_build
...
CPack: - package: /Users/mac/Kutyirov/workspace/projects/lab08/_build/print-0...-Darwin.tar.gz generated.
...
CPack: - package: /Users/mac/Kutyirov/workspace/projects/lab08/_build/print-0...-Darwin.dmg generated.
